...
export const transMailBookingNew = {
    subject: "Email notification of booking progress at DoctorCare",
    template: (data) => {
        return `<h3>Thank you for booking an appointment at DoctorCare's system </h3>
        ...
        <h4>DoctorCare system will automatically send email notification when confirmed appointment is complete. Thank you !</h4>`;
    },
};
...
export const transMailRemedy= {
    ...
    template: (data) => {
        ...
        <br>
        <div>For example: Full name: Hue Truong, with the registered phone number: 0123456789 and born: 1910, the extracted password is: <b> huetruong-012-10 </b> </div>
        <br>
